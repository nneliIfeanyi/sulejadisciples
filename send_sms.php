...
$xml_url = "https://api.ebulksms.com/sendsms.xml";
$http_get_url = "https://api.ebulksms.com/sendsms";
$username = 'nnelivictor1@gmail.com';
$apikey = '1182ff2a2bccc7228aa67ea33ff9b7039aa9520f';
    ...
    <body>
        ...
        <div style="border: 1px solid #333; padding: 5px 10px; width: 40%; margin: 0 auto">
            <form id="form1" name="form1" method="post" action="">
				...
				<input type="hidden" value="nnelivictor1@gmail.com" name="username" type="text" id="username"/>

				<input type="hidden" value="1182ff2a2bccc7228aa67ea33ff9b7039aa9520f" name="apikey" type="password" id="passwd" />
